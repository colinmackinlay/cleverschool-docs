---
title: "Configure Clever School Australia for Your School"
...
You can add staff to Clever School Australia in two ways:
...
For schools that use a supported Management Information System (MIS), Clever School Australia integrates with **Wonde** to keep your staff list synchronised automatically. Once connected, new staff accounts can be created and existing ones updated directly from your MIS data, reducing manual administration.
...
Clever School Australia uses a layered role model to keep access clear and appropriately controlled at every level of your school.
...
Clever School Australia supports login via external identity providers — including **Google** and **Microsoft** — so your staff can use single sign-on (SSO) with their existing school email credentials. This removes the need for a separate Clever School Australia password and makes it easier to enforce your school's existing security policies.

To enable external authentication, go to **Administration** > **Authentication** and follow the on-screen instructions to connect your preferred provider. Once configured, staff can sign in by selecting the relevant provider on the login page. Their school email address is used to match them to their Clever School Australia account automatically.

<Note>
  External authentication must be configured by an Administrator. If you need help connecting your school's Google Workspace or Microsoft 365 tenant, contact [support@cleverschool.au](mailto:support@cleverschool.au).
</Note>
