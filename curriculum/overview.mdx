...
<Tip>
  Contact [support@cleverschool.au](mailto:support@cleverschool.au) to get your school's unique API URL.
</Tip>

The API follows this structure:

```
GET https://cleverschool.au/api/curriculum/{school-id}/year/{year}/subject/{subject}
```
