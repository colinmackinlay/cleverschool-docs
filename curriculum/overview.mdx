...
description: "The Curriculum module lets subject leads draft and publish structured curriculum content — including SMSC coverage and vocabulary — available via a school-specific JSON API for your website."
---
