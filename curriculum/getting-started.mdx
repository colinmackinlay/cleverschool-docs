---
title: "Build and Publish Your School Curriculum to the Website"
...
<Steps>
  <Step title="Get your school's API URL">
    Contact the Clever School Australia support team at **support@cleverschool.au** to receive your school's unique JSON API URL and the accompanying API documentation.
  </Step>
  ...
  <Step title="Keep the curriculum up to date">
    Whenever subject leads update and publish units in Clever School Australia, the changes are reflected on your website automatically at the next API call — no further action needed from your web team.
  </Step>
</Steps>

<Tip>
  If your school uses a website platform with pre-built Clever School Australia integration, the API connection may already be configured. Contact **support@cleverschool.au** to confirm whether an integration exists for your platform.
</Tip>
